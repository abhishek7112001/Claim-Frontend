  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get("https://stateful-claim-management-system.onrender.com/api/auth/login/user", {
    ...
    const fetchClaims = async () => {
      try {
        const token = localStorage.getItem("token");
        const response = await axios.get("https://stateful-claim-management-system.onrender.com/api/claims", {
          headers: { Authorization: `Bearer ${token}` },
        });
